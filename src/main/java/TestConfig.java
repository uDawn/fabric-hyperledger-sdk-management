...
public class TestConfig {
    ...
    private static final String DEFAULT_CONFIG = "src/main/java/op.properties";
...
//                    DEFAULT_CONFIG));
            ...
            try{
                this.inStream = TestConfig.class.getResourceAsStream("/management.properties");
            ...
            for (Map.Entry<String, SampleOrg> org : sampleOrgs.entrySet()) {
                ...
                if (runningFabricCATLS) {
                    String cert = this.operation_properties.getProperty("hyperledger.fabric.operation.peerorgcert").replaceAll("DNAME", domainName);
    ...
    public String getTestChannelPath() {
        return this.operation_properties.getProperty("hyperledger.fabric.operation.channelpath");
